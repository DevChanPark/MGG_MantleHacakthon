...
export const initialMockBattles: FeedBattle[] = [
  {
    id: 'battle-open-win-receipt',
    type: 'TEXT_OPEN',
    author: 'Me',
    title: 'Win Dummy Battle',
    description: 'Completed dummy battle for checking the won-game area in My Page.',
    likeCount: 31,
    status: 'COMPLETED',
    recommendedScore: 92,
    ...
    comments: [
      {
        id: 'comment-alarm-win',
        author: 'Me',
        text: 'My winning dummy answer.',
        likeCount: 12,
      },
      {
        id: 'comment-alarm-2',
  ...
  {
    id: 'battle-evaluating-office-chair',
    type: 'TEXT_OPEN',
    author: 'Sample User',
    title: 'AI Evaluating Dummy Battle',
    description: 'Dummy battle for checking the AI evaluation in-progress state.',
    likeCount: 22,
    status: 'EVALUATING',
    recommendedScore: 90,
    createdAt: '2026-06-13T15:45:00+09:00',
    deadline: '2026-06-14 23:59',
    comments: [
      {
        id: 'comment-chair-1',
        author: 'Sample User A',
        text: 'Sample answer A.',
        likeCount: 5,
      },
      {
        id: 'comment-chair-2',
        author: 'Sample User B',
        text: 'Sample answer B.',
        likeCount: 3,
      },
    ],
  },
  {
    id: 'battle-option-commute',
    type: 'OPTION',
    author: 'Sample User',
    title: 'Bettable Side Pick Dummy Battle',
    description: 'Open dummy battle for checking option selection before the deadline.',
    likeCount: 20,
    status: 'OPEN',
    recommendedScore: 97,
    ...
    comments: [
      {
        id: 'comment-commute-1',
        author: 'Sample User A',
        text: 'Sample option answer A.',
        likeCount: 4,
      },
      {
        id: 'comment-commute-2',
        author: 'Sample User B',
        text: 'Sample option answer B.',
        likeCount: 3,
      },
    ],
  },
